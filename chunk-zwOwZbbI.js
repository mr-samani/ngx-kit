import {Z as Z$1,L as Le,V,H as H$1,P as Pt$1,T as Te,q as qe$1,Q as Qe$1,M as Me}from'./chunk-eNqMGN7N.js';import {bz as a,d as dD,ac as Wt,aG as Ln$1,aH as $e$1,aI as Dt$1,aK as kn,aL as tn,aM as zt,A as Ai$1,P as Pw,t as tl,aN as Yh,aO as DE,a as bh,a5 as xh,B as BD,T as Th,R as RI,aQ as Zh,aR as TE,H as Hh,$ as $D,z as zw,aU as Hw,a8 as pD,a9 as Su,aP as eT,i as iw,e as Gh,aS as nT,b,s as Rr,aZ as j0,bD as le,S,bg as P0,g as gt$1,bE as L0,j as ft$1,Y as oe,_ as _a,av as lu,au as xe,bF as vm,as as vo$1,aj as du,be as lm,bG as $0,aw as kt$1,ad as aw,a0 as yh,ae as cw,br as Lh,b6 as Oh,bs as fw,x as uw,y as dw,bH as Ph,v as kh,U as Ue$1,bI as fg,bu as by,bJ as H0,am as dd,an as fd,az as pw,w as wh,aW as y,aX as P,aY as Ao$1,bK as B0,bx as Nh,a1 as bw,bL as Ar,bM as ba,u as mD,bN as j,C as Ch,n as nl,r as rl,p as mE,D as ve,bO as pr,M as ce,L as zi$1,Q as U0,E as r,bP as cy,m as dr,bQ as Cr,bR as $e$2,a2 as sl,bS as ly,ak as M,bT as Em,ab as pp,b7 as s,bU as Rn$1,aB as oT}from'./main-NZMCD54A.js';import {l as ld}from'./chunk-Dqu3jJUR.js';function pt(i){return i.buttons===0||i.detail===0}function ut(i){let t=i.touches&&i.touches[0]||i.changedTouches&&i.changedTouches[0];return !!t&&t.identifier===-1&&(t.radiusX==null||t.radiusX===1)&&(t.radiusY==null||t.radiusY===1)}function ye(i){if(i.composedPath)try{return i.composedPath()[0]}catch{}return i.target}var Se;function Cn(){if(Se==null&&typeof window<"u")try{window.addEventListener("test",null,Object.defineProperty({},"passive",{get:()=>Se=!0}));}finally{Se=Se||false;}return Se}function He(i){return Cn()?i:!!i.capture}var je=new WeakMap,ie=(()=>{class i{_appRef;_injector=b(ve);_environmentInjector=b(ce);load(e){let n=this._appRef=this._appRef||this._injector.get(zi$1),o=je.get(n);o||(o={loaders:new Set,refs:[]},je.set(n,o),n.onDestroy(()=>{je.get(n)?.refs.forEach(a=>a.destroy()),je.delete(n);})),o.loaders.has(e)||(o.loaders.add(e),o.refs.push(U0(e,{environmentInjector:this._environmentInjector})));}static \u0275fac=function(n){return new(n||i)};static \u0275prov=Ar({token:i,factory:i.\u0275fac})}return i})();var En=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275cmp=dD({type:i,selectors:[["ng-component"]],exportAs:["cdkVisuallyHidden"],decls:0,vars:0,template:function(n,o){},styles:[`.cdk-visually-hidden {
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
