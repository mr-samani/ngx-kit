import {Z as Z$1,L as Le,V,H as H$1,P as Pt$1,T as Te,q as qe$1,Q as Qe$1,M as Me}from'./chunk-DZpZhHI4.js';import {bx as a,d as dD,a7 as Wt,aB as Ln$1,aC as $e$1,aD as Dt$1,aF as kn,aG as tn,aH as zt,A as Ai$1,P as Pw,t as tl,aI as Yh,aJ as DE,a as bh,a0 as xh,B as BD,T as Th,R as RI,aL as Zh,aM as TE,H as Hh,$ as $D,z as zw,aP as Hw,a3 as pD,a4 as Su,aK as eT,i as iw,e as Gh,aN as nT,b,s as Rr,aV as j0,bC as le,S,be as P0,g as gt$1,bD as L0,j as ft$1,K as oe,_ as _a,aq as lu,ap as xe,bE as vm,an as vo$1,ae as du,bc as lm,bF as $0,ar as kt$1,a8 as aw,M as yh,a9 as cw,bp as Lh,b2 as Oh,bq as fw,b3 as uw,b4 as dw,bG as Ph,bH as kh,aQ as Ue$1,bI as fg,bs as by,bJ as H0,ah as dd,ai as fd,au as pw,w as wh,aS as y,aT as P,aU as Ao$1,bK as B0,bv as Nh,Q as bw,bL as Ar,bM as ba,u as mD,bN as j,C as Ch,n as nl,r as rl,p as mE,I as ve,bO as pr,D as ce,y as zi$1,U as U0,v as r,bP as cy,m as dr,bQ as Cr,bR as $e$2,X as sl,bS as ly,af as M,bT as Em,a6 as pp,b5 as s,bU as Rn$1,aw as oT}from'./main-6A6LSTQL.js';import {l as ld}from'./chunk-lRtULxMq.js';function pt(i){return i.buttons===0||i.detail===0}function ut(i){let t=i.touches&&i.touches[0]||i.changedTouches&&i.changedTouches[0];return !!t&&t.identifier===-1&&(t.radiusX==null||t.radiusX===1)&&(t.radiusY==null||t.radiusY===1)}function ye(i){if(i.composedPath)try{return i.composedPath()[0]}catch{}return i.target}var Se;function Cn(){if(Se==null&&typeof window<"u")try{window.addEventListener("test",null,Object.defineProperty({},"passive",{get:()=>Se=!0}));}finally{Se=Se||false;}return Se}function He(i){return Cn()?i:!!i.capture}var je=new WeakMap,ie=(()=>{class i{_appRef;_injector=b(ve);_environmentInjector=b(ce);load(e){let n=this._appRef=this._appRef||this._injector.get(zi$1),o=je.get(n);o||(o={loaders:new Set,refs:[]},je.set(n,o),n.onDestroy(()=>{je.get(n)?.refs.forEach(a=>a.destroy()),je.delete(n);})),o.loaders.has(e)||(o.loaders.add(e),o.refs.push(U0(e,{environmentInjector:this._environmentInjector})));}static \u0275fac=function(n){return new(n||i)};static \u0275prov=Ar({token:i,factory:i.\u0275fac})}return i})();var En=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275cmp=dD({type:i,selectors:[["ng-component"]],exportAs:["cdkVisuallyHidden"],decls:0,vars:0,template:function(n,o){},styles:[`.cdk-visually-hidden {
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
...
`],encapsulation:2})}return i})();var Ue=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=pD({type:i});static \u0275inj=Su({imports:[Z$1]})}return i})();var Nn=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=pD({type:i});static \u0275inj=Su({imports:[Ue,Z$1]})}return i})();var Ni=["*"],Bn=(()=>{class i{labelPosition="after";static \u0275fac=function(n){return new(n||i)};static \u0275cmp=dD({type:i,selectors:[["","mat-internal-form-field",""]],hostAttrs:[1,"mdc-form-field","mat-internal-form-field"],hostVars:2,hostBindings:function(n,o){n&2&&Hh("mdc-form-field--align-end",o.labelPosition==="before");},inputs:{labelPosition:"labelPosition"},ngContentSelectors:Ni,decls:1,vars:0,template:function(n,o){n&1&&(aw(),cw(0));},styles:[`.mat-internal-form-field {
...
`],encapsulation:2})}return i})();var Ro=["text"],Do=[[["mat-icon"]],"*"],To=["mat-icon","*"];function Fo(i,t){if(i&1&&bh(0,"mat-pseudo-checkbox",1),i&2){let e=iw();Th("disabled",e.disabled)("state",e.selected?"checked":"unchecked");}}function Po(i,t){if(i&1&&bh(0,"mat-pseudo-checkbox",3),i&2){let e=iw();Th("disabled",e.disabled);}}function Ao(i,t){if(i&1&&(Ai$1(0,"span",4),Pw(1),tl()),i&2){let e=iw();RI(),sl("(",e.group.label,")");}}var Io=new S("MAT_OPTION_PARENT_COMPONENT"),Lo=new S("MatOptgroup");var It=class{source;isUserInput;constructor(t,e=false){this.source=t,this.isUserInput=e;}},wi=(()=>{class i{_element=b(Rr);_changeDetectorRef=b(j0);_parent=b(Io,{optional:true});group=b(Lo,{optional:true});_signalDisableRipple=false;_selected=false;_active=false;_mostRecentViewValue="";get multiple(){return this._parent&&this._parent.multiple}get selected(){return this._selected}value;id=b(Z).getId("mat-option-");get disabled(){return this.group&&this.group.disabled||this._disabled()}set disabled(e){this._disabled.set(e);}_disabled=ft$1(false);get disableRipple(){return this._signalDisableRipple?this._parent.disableRipple():!!this._parent?.disableRipple}get hideSingleSelectionIndicator(){return !!(this._parent&&this._parent.hideSingleSelectionIndicator)}onSelectionChange=new Ue$1;_text;_stateChanges=new oe;constructor(){let e=b(ie);e.load(Ye),e.load(En),this._signalDisableRipple=!!this._parent&&pr(this._parent.disableRipple);}get active(){return this._active}get viewValue(){return (this._text?.nativeElement.textContent||"").trim()}select(e=true){this._selected||(this._selected=true,this._changeDetectorRef.markForCheck(),e&&this._emitSelectionChangeEvent());}deselect(e=true){this._selected&&(this._selected=false,this._changeDetectorRef.markForCheck(),e&&this._emitSelectionChangeEvent());}focus(e,n){let o=this._getHostElement();typeof o.focus=="function"&&o.focus(n);}setActiveStyles(){this._active||(this._active=true,this._changeDetectorRef.markForCheck());}setInactiveStyles(){this._active&&(this._active=false,this._changeDetectorRef.markForCheck());}getLabel(){return this.viewValue}_handleKeydown(e){(e.keyCode===13||e.keyCode===32)&&!On(e)&&(this._selectViaInteraction(),e.preventDefault());}_selectViaInteraction(){this.disabled||(this._selected=this.multiple?!this._selected:true,this._changeDetectorRef.markForCheck(),this._emitSelectionChangeEvent(true));}_getTabIndex(){return this.disabled?"-1":"0"}_getHostElement(){return this._element.nativeElement}ngAfterViewChecked(){if(this._selected){let e=this.viewValue;e!==this._mostRecentViewValue&&(this._mostRecentViewValue&&this._stateChanges.next(),this._mostRecentViewValue=e);}}ngOnDestroy(){this._stateChanges.complete();}_emitSelectionChangeEvent(e=false){this.onSelectionChange.emit(new It(this,e));}static \u0275fac=function(n){return new(n||i)};static \u0275cmp=dD({type:i,selectors:[["mat-option"]],viewQuery:function(n,o){if(n&1&&Oh(Ro,7),n&2){let a;uw(a=dw())&&(o._text=a.first);}},hostAttrs:["role","option",1,"mat-mdc-option","mdc-list-item"],hostVars:11,hostBindings:function(n,o){n&1&&xh("click",function(){return o._selectViaInteraction()})("keydown",function(r){return o._handleKeydown(r)}),n&2&&(Nh("id",o.id),wh("aria-selected",o.selected)("aria-disabled",o.disabled.toString()),Hh("mdc-list-item--selected",o.selected)("mat-mdc-option-multiple",o.multiple)("mat-mdc-option-active",o.active)("mdc-list-item--disabled",o.disabled));},inputs:{value:"value",id:"id",disabled:[2,"disabled","disabled",H0]},outputs:{onSelectionChange:"onSelectionChange"},exportAs:["matOption"],ngContentSelectors:To,decls:8,vars:5,consts:[["text",""],["aria-hidden","true",1,"mat-mdc-option-pseudo-checkbox",3,"disabled","state"],[1,"mdc-list-item__primary-text"],["state","checked","aria-hidden","true","appearance","minimal",1,"mat-mdc-option-pseudo-checkbox",3,"disabled"],[1,"cdk-visually-hidden"],["aria-hidden","true","mat-ripple","",1,"mat-mdc-option-ripple","mat-focus-indicator",3,"matRippleTrigger","matRippleDisabled"]],template:function(n,o){n&1&&(aw(Do),BD(0,Fo,1,2,"mat-pseudo-checkbox",1),cw(1),Ai$1(2,"span",2,0),cw(4,1),tl(),BD(5,Po,1,1,"mat-pseudo-checkbox",3),BD(6,Ao,2,1,"span",4),bh(7,"div",5)),n&2&&($D(o.multiple?0:-1),RI(5),$D(!o.multiple&&o.selected&&!o.hideSingleSelectionIndicator?5:-1),RI(),$D(o.group&&o.group._inert?6:-1),RI(),Th("matRippleTrigger",o._getHostElement())("matRippleDisabled",o.disabled||o.disableRipple));},dependencies:[ki,We],styles:[`.mat-mdc-option {
...
`],encapsulation:2})}return i})();var Ci=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=pD({type:i});static \u0275inj=Su({imports:[Z$1]})}return i})();var Lt=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=pD({type:i});static \u0275inj=Su({imports:[Ue,Ci,wi,Z$1]})}return i})();var Ei=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=pD({type:i});static \u0275inj=Su({imports:[At,Lt,Z$1,Le,he,Lt]})}return i})();var it=class{constructor(t){this.config=t;}config;useOverlay;title="";text="";html="";backdrop=true;icon;width;allowOutsideClick=true;allowEscapeKey=true;allowEnterKey=true;showConfirmButton=true;showDenyButton=false;showCancelButton=false;confirmButtonText="Ok";denyButtonText="No";cancelButtonText="Cancel";confirmButtonColor;denyButtonColor;cancelButtonColor;confirmButtonAriaLabel="";denyButtonAriaLabel="";cancelButtonAriaLabel="";reverseButtons=false;showCloseButton=false;containerClass=""};function No(i,t){if(i&1&&(Ai$1(0,"pre",38),Pw(1),eT(2,"json"),tl()),i&2){let e=iw();RI(),Gh(nT(2,1,e.result));}}function Bo(i,t){i&1&&(Ai$1(0,"div",39),Pw(1," No result yet. Show the message to see its result. "),tl());}var Mi=class i{sourceFiles=[{label:"TS",path:"examples/message/message.ts",language:"typescript"},{label:"HTML",path:"examples/message/message.html",language:"html"}];options=new it;result;constructor(){this.options.title="Message Title",this.options.text="Message Body",this.options.icon="success",this.options.useOverlay=true,this.options.showCloseButton=true,this.options.showCancelButton=true;}openModal(){a.show(this.options).afterClose.subscribe(t=>{this.result=t;});}showLoading(){let t=a.fire({icon:"loading",text:"Please Wait...",showConfirmButton:false,showCancelButton:false,showDenyButton:false,allowEnterKey:false,allowEscapeKey:false,allowOutsideClick:false,showCloseButton:false});t.afterClose.subscribe(e=>{console.log(e);}),setTimeout(()=>{t.close();},5e3);}static \u0275fac=function(e){return new(e||i)};static \u0275cmp=dD({type:i,selectors:[["app-message"]],features:[zw([])],decls:139,vars:30,consts:[["title","Message","readmePath","readmes/message/README.md",3,"files"],[1,"demo-playground"],[1,"config-preview"],[1,"demo-configuration"],[1,"demo-section"],[1,"demo-section-header"],[1,"demo-section-title"],[1,"demo-section-description"],[1,"badge"],[1,"demo-grid"],[1,"demo-field"],[1,"demo-field-label"],["type","text","name","title","placeholder","Message title",1,"demo-input",3,"ngModelChange","ngModel"],["type","text","name","text","placeholder","Message body",1,"demo-input",3,"ngModelChange","ngModel"],[2,"height","14px"],["name","html","placeholder","<strong>Hello</strong>",1,"demo-textarea",3,"ngModelChange","ngModel"],[1,"demo-field-hint"],[1,"demo-choice"],["type","button",1,"demo-choice-item",3,"click"],[1,"demo-check-grid"],[1,"demo-check"],["type","checkbox","name","showCloseButton",3,"ngModelChange","ngModel"],[1,"demo-check-box"],["type","checkbox","name","allowOutsideClick",3,"ngModelChange","ngModel"],["type","checkbox","name","allowEnterKey",3,"ngModelChange","ngModel"],["type","checkbox","name","allowEscapeKey",3,"ngModelChange","ngModel"],["type","checkbox","name","useOverlay",3,"ngModelChange","ngModel"],["type","checkbox","name","showConfirmButton",3,"ngModelChange","ngModel"],[2,"height","10px"],["type","text","name","confirmButtonText",1,"demo-input",3,"ngModelChange","ngModel"],["type","checkbox","name","showCancelButton",3,"ngModelChange","ngModel"],["type","text","name","cancelButtonText",1,"demo-input",3,"ngModelChange","ngModel"],["type","checkbox","name","showDenyButton",3,"ngModelChange","ngModel"],["type","text","name","denyButtonText",1,"demo-input",3,"ngModelChange","ngModel"],[1,"demo-preview"],[1,"demo-actions"],["type","button",1,"demo-button","primary",3,"click"],["type","button",1,"demo-button","secondary",3,"click"],[1,"demo-result"],[1,"demo-result","demo-empty"]],template:function(e,n){e&1&&(Ai$1(0,"app-example-showcase",0)(1,"div",1)(2,"div",2)(3,"div",3)(4,"section",4)(5,"div",5)(6,"div")(7,"h3",6),Pw(8,"Content"),tl(),Ai$1(9,"p",7),Pw(10,"Configure the title and message content."),tl()(),Ai$1(11,"span",8),Pw(12,"Message"),tl()(),Ai$1(13,"div",9)(14,"label",10)(15,"span",11),Pw(16,"Title"),tl(),Ai$1(17,"input",12),Yh("ngModelChange",function(a){return Hw(n.options.title,a)||(n.options.title=a),a}),tl(),DE(),tl(),Ai$1(18,"label",10)(19,"span",11),Pw(20,"Text"),tl(),Ai$1(21,"input",13),Yh("ngModelChange",function(a){return Hw(n.options.text,a)||(n.options.text=a),a}),tl(),DE(),tl()(),bh(22,"div",14),Ai$1(23,"label",10)(24,"span",11),Pw(25,"HTML content"),tl(),Ai$1(26,"textarea",15),Yh("ngModelChange",function(a){return Hw(n.options.html,a)||(n.options.html=a),a}),tl(),DE(),Ai$1(27,"span",16),Pw(28,"Optional HTML content rendered inside the message."),tl()(),Ai$1(29,"div",5)(30,"div")(31,"h3",6),Pw(32,"Icon"),tl(),Ai$1(33,"p",7),Pw(34,"Select the visual state of the message."),tl()()(),Ai$1(35,"div",17)(36,"button",18),xh("click",function(){return n.options.icon=void 0}),Pw(37," None "),tl(),Ai$1(38,"button",18),xh("click",function(){return n.options.icon="success"}),Pw(39," Success "),tl(),Ai$1(40,"button",18),xh("click",function(){return n.options.icon="error"}),Pw(41," Error "),tl(),Ai$1(42,"button",18),xh("click",function(){return n.options.icon="info"}),Pw(43," Info "),tl(),Ai$1(44,"button",18),xh("click",function(){return n.options.icon="warning"}),Pw(45," Warning "),tl(),Ai$1(46,"button",18),xh("click",function(){return n.options.icon="question"}),Pw(47," Question "),tl(),Ai$1(48,"button",18),xh("click",function(){return n.options.icon="loading"}),Pw(49," Loading "),tl()(),Ai$1(50,"div",5)(51,"div")(52,"h3",6),Pw(53,"Behavior"),tl(),Ai$1(54,"p",7),Pw(55," Configure how the message can be dismissed and interacted with. "),tl()()(),Ai$1(56,"div",19)(57,"label",20)(58,"input",21),Yh("ngModelChange",function(a){return Hw(n.options.showCloseButton,a)||(n.options.showCloseButton=a),a}),tl(),DE(),bh(59,"span",22),Ai$1(60,"span"),Pw(61,"Show close button"),tl()(),Ai$1(62,"label",20)(63,"input",23),Yh("ngModelChange",function(a){return Hw(n.options.allowOutsideClick,a)||(n.options.allowOutsideClick=a),a}),tl(),DE(),bh(64,"span",22),Ai$1(65,"span"),Pw(66,"Allow outside click"),tl()(),Ai$1(67,"label",20)(68,"input",24),Yh("ngModelChange",function(a){return Hw(n.options.allowEnterKey,a)||(n.options.allowEnterKey=a),a}),tl(),DE(),bh(69,"span",22),Ai$1(70,"span"),Pw(71,"Allow Enter key"),tl()(),Ai$1(72,"label",20)(73,"input",25),Yh("ngModelChange",function(a){return Hw(n.options.allowEscapeKey,a)||(n.options.allowEscapeKey=a),a}),tl(),DE(),bh(74,"span",22),Ai$1(75,"span"),Pw(76,"Allow Escape key"),tl()(),Ai$1(77,"label",20)(78,"input",26),Yh("ngModelChange",function(a){return Hw(n.options.useOverlay,a)||(n.options.useOverlay=a),a}),tl(),DE(),bh(79,"span",22),Ai$1(80,"span"),Pw(81,"Use Overlay popover"),tl()()(),Ai$1(82,"div",5)(83,"div")(84,"h3",6),Pw(85,"Buttons"),tl(),Ai$1(86,"p",7),Pw(87," Configure the action buttons displayed by the message. "),tl()()(),Ai$1(88,"div",9)(89,"div")(90,"label",20)(91,"input",27),Yh("ngModelChange",function(a){return Hw(n.options.showConfirmButton,a)||(n.options.showConfirmButton=a),a}),tl(),DE(),bh(92,"span",22),Ai$1(93,"span"),Pw(94,"Show confirm button"),tl()(),bh(95,"div",28),Ai$1(96,"label",10)(97,"span",11),Pw(98,"Confirm text"),tl(),Ai$1(99,"input",29),Yh("ngModelChange",function(a){return Hw(n.options.confirmButtonText,a)||(n.options.confirmButtonText=a),a}),tl(),DE(),tl()(),Ai$1(100,"div")(101,"label",20)(102,"input",30),Yh("ngModelChange",function(a){return Hw(n.options.showCancelButton,a)||(n.options.showCancelButton=a),a}),tl(),DE(),bh(103,"span",22),Ai$1(104,"span"),Pw(105,"Show cancel button"),tl()(),bh(106,"div",28),Ai$1(107,"label",10)(108,"span",11),Pw(109,"Cancel text"),tl(),Ai$1(110,"input",31),Yh("ngModelChange",function(a){return Hw(n.options.cancelButtonText,a)||(n.options.cancelButtonText=a),a}),tl(),DE(),tl()(),Ai$1(111,"div")(112,"label",20)(113,"input",32),Yh("ngModelChange",function(a){return Hw(n.options.showDenyButton,a)||(n.options.showDenyButton=a),a}),tl(),DE(),bh(114,"span",22),Ai$1(115,"span"),Pw(116,"Show deny button"),tl()(),bh(117,"div",28),Ai$1(118,"label",10)(119,"span",11),Pw(120,"Deny text"),tl(),Ai$1(121,"input",33),Yh("ngModelChange",function(a){return Hw(n.options.denyButtonText,a)||(n.options.denyButtonText=a),a}),tl(),DE(),tl()()()()(),Ai$1(122,"div",34)(123,"div",35)(124,"button",36),xh("click",function(){return n.openModal()}),Ai$1(125,"span"),Pw(126,"\u2726"),tl(),Pw(127," Show Message "),tl(),Ai$1(128,"button",37),xh("click",function(){return n.showLoading()}),Pw(129," Show 5s Loading "),tl()(),Ai$1(130,"section",4)(131,"div",5)(132,"div")(133,"h3",6),Pw(134,"Result"),tl(),Ai$1(135,"p",7),Pw(136," Result returned by the message after it is closed. "),tl()()(),BD(137,No,3,3,"pre",38)(138,Bo,2,0,"div",39),tl()()()()()),e&2&&(Th("files",n.sourceFiles),RI(17),Zh("ngModel",n.options.title),TE(),RI(4),Zh("ngModel",n.options.text),TE(),RI(5),Zh("ngModel",n.options.html),TE(),RI(10),Hh("active",n.options.icon===void 0),RI(2),Hh("active",n.options.icon==="success"),RI(2),Hh("active",n.options.icon==="error"),RI(2),Hh("active",n.options.icon==="info"),RI(2),Hh("active",n.options.icon==="warning"),RI(2),Hh("active",n.options.icon==="question"),RI(2),Hh("active",n.options.icon==="loading"),RI(10),Zh("ngModel",n.options.showCloseButton),TE(),RI(5),Zh("ngModel",n.options.allowOutsideClick),TE(),RI(5),Zh("ngModel",n.options.allowEnterKey),TE(),RI(5),Zh("ngModel",n.options.allowEscapeKey),TE(),RI(5),Zh("ngModel",n.options.useOverlay),TE(),RI(13),Zh("ngModel",n.options.showConfirmButton),TE(),RI(8),Zh("ngModel",n.options.confirmButtonText),TE(),RI(3),Zh("ngModel",n.options.showCancelButton),TE(),RI(8),Zh("ngModel",n.options.cancelButtonText),TE(),RI(3),Zh("ngModel",n.options.showDenyButton),TE(),RI(8),Zh("ngModel",n.options.denyButtonText),TE(),RI(16),$D(n.result?137:138));},dependencies:[Wt,Ln$1,$e$1,Dt$1,kn,tn,he,ei,Nn,Ei,zn,ld,zt],styles:[".configuration[_ngcontent-%COMP%]{display:flex;gap:20px;flex-wrap:wrap;align-items:center}"]})};export{Mi as MessageComponent};