...
@Component({
  ...
  template: `
    <span class="boolean-badge" [class.boolean-badge--yes]="value()" [class.boolean-badge--no]="!value()">
      {{ value() ? 'بله' : 'خیر' }}
    </span>
  `,
  styles: `
    ...
    .boolean-badge {
      ...
      min-width: 42px; padding: 4px 10px; border-radius: 20px; font-size: 12px; font-weight: 500;
    }
    .boolean-badge--yes { color: #166534; background: #dcfce7; }
    .boolean-badge--no { color: #991b1b; background: #fee2e2; }
  `,
})
