  ...
  template: `
    @if (indicator().visible) {
      @if (indicator().highlightRect; as r) {
        ...
        <div
          class="flow-indicator flow-indicator--h"
          [style.top.px]="indicator().y"
          [style.left.px]="indicator().x"
          [style.width.px]="indicator().length"></div>
      } @else if (indicator().orientation === 'v') {
        <div
          class="flow-indicator flow-indicator--v"
          [style.top.px]="indicator().y"
          [style.left.px]="indicator().x"
          [style.height.px]="indicator().length"></div>
      }
    }
  `,
  styles: [
