import {Z as Z$1,L as Le,V,H as H$1,P as Pt$1,T as Te,q as qe$1,Q as Qe$1,M as Me}from'./chunk-Uj0oibwx.js';import {bv as a,R as RE,ad as Wt,ay as Ln$1,az as $e$1,aA as Dt$1,aC as kn,aD as tn,aE as zt,E as Ei$1,J as JD,U as Uc,af as wh,aG as $I,Y as Yp,a1 as nh,h as oD,Z as Zp,e as eI,aj as Dh,aI as qI,f as fh,i as iD,y as uw,at as rw,ab as OE,ac as mu,aH as gw,w as wD,v as vh,aJ as yw,b,_ as _r,aP as o0,bA as Se$1,x,ba as t0,g as gt$1,bB as n0,p as ft$1,I as te,j as ha,ar as Yl,aq as Ce,bC as Wg,ao as co$1,a9 as Jl,b8 as Lg,bD as c0,bn as kt$1,a5 as bD,M as Up,a7 as CD,bl as ch,aZ as sh,bm as SD,a_ as MD,a$ as ND,bE as ah,bF as ih,$ as $e$2,bG as Vh,bq as Jm,bH as s0,ag as Ju,ah as Xu,aF as xD,Q as Qp,aM as y,aN as P,aO as wo$1,bI as a0,bt as eh,S as BD,bJ as Cr,bK as fa,u as FE,bL as j,K as Kp,q as qc,W as Wc,t as jI,H as ge,bM as ur,C as se,B as Li,D as l0,z as r,bN as Pm,r as cr,bO as Er,bP as $e$3,T as Qc,bQ as Lm,aa as M,bR as zg,a4 as xv,b0 as s,bS as Sn$1,bp as Iw}from'./main-FGSS66VU.js';import {l as ld}from'./chunk-CH3xViht.js';function pt(i){return i.buttons===0||i.detail===0}function ut(i){let t=i.touches&&i.touches[0]||i.changedTouches&&i.changedTouches[0];return !!t&&t.identifier===-1&&(t.radiusX==null||t.radiusX===1)&&(t.radiusY==null||t.radiusY===1)}function ye(i){if(i.composedPath)try{return i.composedPath()[0]}catch{}return i.target}var Se;function Cn(){if(Se==null&&typeof window<"u")try{window.addEventListener("test",null,Object.defineProperty({},"passive",{get:()=>Se=!0}));}finally{Se=Se||false;}return Se}function He(i){return Cn()?i:!!i.capture}var je=new WeakMap,ie=(()=>{class i{_appRef;_injector=b(ge);_environmentInjector=b(se);load(e){let n=this._appRef=this._appRef||this._injector.get(Li),o=je.get(n);o||(o={loaders:new Set,refs:[]},je.set(n,o),n.onDestroy(()=>{je.get(n)?.refs.forEach(a=>a.destroy()),je.delete(n);})),o.loaders.has(e)||(o.loaders.add(e),o.refs.push(l0(e,{environmentInjector:this._environmentInjector})));}static \u0275fac=function(n){return new(n||i)};static \u0275prov=Cr({token:i,factory:i.\u0275fac})}return i})();var En=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275cmp=RE({type:i,selectors:[["ng-component"]],exportAs:["cdkVisuallyHidden"],decls:0,vars:0,template:function(n,o){},styles:[`.cdk-visually-hidden {
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
