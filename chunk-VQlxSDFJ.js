import {Z as Z$1,L as Le,V,H as H$1,P as Pt$1,T as Te,q as qe$1,Q as Qe$1,M as Me}from'./chunk-caEX4oxF.js';import {br as a,d as dC,a5 as f_,au as Ln$1,av as $e$1,aw as Dt$1,ay as kn,az as tn,aA as c_,q as qi$1,T as Tw,O as Ou,a7 as bg,aC as CI,J as Jh,a8 as og,f as kC,K as Kh,F as FE,ac as wg,aE as bI,h as hg,g as FC,N as jw,at as Aw,a3 as Nu,a4 as Qo,aD as Uw,Q as QC,e as Eg,aF as zw,E,i as dt,aL as tm,bx as Ue$1,S,b6 as wj,k as kt$1,by as bj,x as xt$1,ao as oe,t as tc,ak as ed,aj as Ve,bz as My,ah as Lo$1,a1 as nd,b4 as Dy,bA as Sj,bj as r_,s as JC,aq as zh,v as XC,bh as lg,aV as cg,bi as rw,aW as tw,aX as nw,bB as ug,bC as ag,P as rt,bD as Hg,bm as Yi$1,bE as Cb,a9 as tf,aa as nf,aB as ow,w as Qh,aI as y,aJ as P,aK as Yo,bF as wb,bp as ng,ar as gw,bG as tr,bH as Xa,M as rr,bI as H$2,X as Xh,b as ku,c as Fu,m as eo$1,am as ue,bJ as Gn$1,Z as ve,W as ls,_ as Mj,U,bK as vv,H as be,bL as Gr,bM as cm,an as ju,bN as Dv,a2 as N,bO as xy,r as dE,aY as G,bP as Ot$1,bl as qw}from'./main-GZ3Q6X22.js';import {l as ld}from'./chunk-i5ffI6CI.js';function pt(i){return i.buttons===0||i.detail===0}function ut(i){let t=i.touches&&i.touches[0]||i.changedTouches&&i.changedTouches[0];return !!t&&t.identifier===-1&&(t.radiusX==null||t.radiusX===1)&&(t.radiusY==null||t.radiusY===1)}function ye(i){if(i.composedPath)try{return i.composedPath()[0]}catch{}return i.target}var Se;function Cn(){if(Se==null&&typeof window<"u")try{window.addEventListener("test",null,Object.defineProperty({},"passive",{get:()=>Se=!0}));}finally{Se=Se||false;}return Se}function He(i){return Cn()?i:!!i.capture}var je=new WeakMap,ie=(()=>{class i{_appRef;_injector=E(ue);_environmentInjector=E(ve);load(e){let n=this._appRef=this._appRef||this._injector.get(ls),o=je.get(n);o||(o={loaders:new Set,refs:[]},je.set(n,o),n.onDestroy(()=>{je.get(n)?.refs.forEach(a=>a.destroy()),je.delete(n);})),o.loaders.has(e)||(o.loaders.add(e),o.refs.push(Mj(e,{environmentInjector:this._environmentInjector})));}static \u0275fac=function(n){return new(n||i)};static \u0275prov=tr({token:i,factory:i.\u0275fac})}return i})();var En=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275cmp=dC({type:i,selectors:[["ng-component"]],exportAs:["cdkVisuallyHidden"],decls:0,vars:0,template:function(n,o){},styles:[`.cdk-visually-hidden {
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
